...
- `DEPRECATED (Tier 2 surgical, see docs/JULES_PY_REMOVAL_HANDOFF_f29c675b.md and PHASE4 checklist)` (post-task flywheel trigger)
...
4. `DEPRECATED (Tier 2 surgical, see docs/JULES_PY_REMOVAL_HANDOFF_f29c675b.md and PHASE4 checklist)` (flywheel portions), `eval/post_process.py` (strip only flywheel trigger blocks; retain PRM/trajectory post_process)
...
- python -m agentforge.rust_flywheel_step ... → agentforge-runner flywheel-step --real-data [--ingest] [--shadow]
  Patch sites: rust_flywheel_step.py (internal), phase2_3_integration.py, bin/rust_flywheel_after_task.sh, agents/*_runner.sh (post_process calls), eval/post_process.py (trigger), DEPRECATED (Tier 2 surgical, see docs/JULES_PY_REMOVAL_HANDOFF_f29c675b.md and PHASE4 checklist), enable_rust_flywheel.py
...
- DEPRECATED (Tier 2 surgical, see docs/JULES_PY_REMOVAL_HANDOFF_f29c675b.md and PHASE4 checklist) + eval/post_process.py (flywheel blocks) : rate limit + shadow bridge
