...
- Post-task: workers + `eval/post_process.py` + `DELETED (Tier2) - direct runner` now **prefer binary** under `is_pure_rust_flywheel()` (see learning/utils.py + hardened bridge code).
