...
## Deliverables
- Created: `/home/eveselove/agentforge/enable_rust_flywheel.py`
...
- Updated: `/home/eveselove/agentforge/bin/enable_rust_flywheel.sh` (now calls the Python module for patch + activation; still produces env snippet)
- Created: `/home/eveselove/agentforge/ENABLE_RUST_FLYWHEEL.md` (full operator guide with one-command + systemd timer + cron examples)
- Also updated sh docs + one-liner for whole-farm.

## Exact One-Command Activation (Whole Farm)
```bash
# From /home/eveselove — does everything (env + binary check + post_process patch)
...
- /home/eveselove/agentforge/enable_rust_flywheel.py (new, canonical activator)
- /home/eveselove/agentforge/bin/enable_rust_flywheel.sh (updated)
- /home/eveselove/agentforge/ENABLE_RUST_FLYWHEEL.md (new, operator doc + timer/cron)
