...
#
_DISABLE_PURE_FILE="/home/agx/agentforge/.disable_pure_rust_flywheel"
_PURE_FILE="/home/agx/agentforge/.pure_rust_flywheel"
...
elif [[ -x "/home/agx/agentforge/rust/target/debug/agentforge-runner" ]]; then
...
PYTHONPATH=/home/agx python -m agentforge.list_pending_candidates list --limit 2 --sort value 2>/dev/null | cat || echo "  (python path exercised)"
echo ""
...
# === 2. REMOTE WORKERS / JETS (grok-work/* + Jetson) ===
# One-liner per host (copy-paste):
#   ssh agent3 'cd /home/agx/agentforge && bash bin/disable_pure_rust_flywheel.sh --dry-run && bash bin/disable_pure_rust_flywheel.sh'
#   ssh agx@146.120.89.199 'cd /home/agx/agentforge && ...'
...
# * ROLLBACK OF THIS DISABLE (re-arm pure): ssh <host> 'bash /home/agx/agentforge/bin/make_pure_rust_flywheel_default.sh --dry-run && bash /home/agx/agentforge/bin/make_pure_rust_flywheel_default.sh'
...
" 2>/dev/null || true
  ...
  ssh -o ConnectTimeout=20 -o BatchMode=yes "$host" '
    ...
    touch /home/agx/agentforge/.disable_pure_rust_flywheel 2>/dev/null || true
    rm -f /home/agx/agentforge/.pure_rust_flywheel 2>/dev/null || true
    export AGENTFORGE_FLYWHEEL_ENGINE=python
    export AGENTFORGE_PURE_RUST_FLYWHEEL=0
    systemctl --user daemon-reload 2>/dev/null || true
  ...
  ssh -o ConnectTimeout=15 -o BatchMode=yes "$host" '
    ...
    bash /home/agx/agentforge/healthcheck.sh 2>/dev/null | grep -E "Flywheel|Timer|Rust|pure|✅|⚠️|engine" | head -10 || true
    echo "--- Markers ---"
    ls -l /home/agx/agentforge/.{pure,disable_pure}_rust_flywheel 2>/dev/null || echo "  (markers checked)"
...
" 2>/dev/null || true
    ...
    tail -8 /home/agx/agentforge/bin/rust_flywheel.env 2>/dev/null || true
...
echo "Next on MAIN:"
echo "  bash /home/agx/agentforge/healthcheck.sh | grep -E \"Flywheel|pure|engine\""
...
echo "  ssh HOST 'bash /home/agx/agentforge/bin/make_pure_rust_flywheel_default.sh --dry-run && bash /home/agx/agentforge/bin/make_pure_rust_flywheel_default.sh'"
echo "================================================================"
...
# ssh agent3 'cd /home/agx/agentforge && bash bin/make_pure_rust_flywheel_default.sh --dry-run && bash bin/make_pure_rust_flywheel_default.sh'
...
if [ $DRY_RUN -eq 0 ]; then
    ...
    PYTHONPATH=/home/agx AGENTFORGE_FLYWHEEL_ENGINE=python timeout 15s python -m agentforge.list_pending_candidates list --limit 1 --sort value 2>&1 | tail -3 || true
fi
