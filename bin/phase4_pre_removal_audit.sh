...
echo "TIER 2: DEPRECATED (Tier 2 surgical, see docs/JULES_PY_REMOVAL_HANDOFF_f29c675b.md and PHASE4 checklist), eval/post_process.py (SURGICAL), eval/runner.py, learning/trajectory_dataset.py, learning/flywheel_parity/"
...
if [ $EMIT_COMMANDS -eq 1 ]; then
    ...
    echo ">>> TIER 2: git rm -f DEPRECATED (Tier 2 surgical, see docs/JULES_PY_REMOVAL_HANDOFF_f29c675b.md and PHASE4 checklist); git rm -rf learning/flywheel_parity/"
