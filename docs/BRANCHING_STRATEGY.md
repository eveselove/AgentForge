...
**Status**: Official  
**Version**: 1.1  
**Last updated**: 2026-06 (A2 branch protection proposal integrated, task bc6fa462)  
...
- Branch protection design for `main` (A2, task bc6fa462) lives in `docs/BRANCH_PROTECTION_A2_PROPOSAL.md` (smallest effective set) and `.github/BRANCH_PROTECTION.md` (A7 decision + current config). Always consult them; implementation is A4.
...
| Branch    | Protection on `main`                      | A2 proposal (`docs/BRANCH_PROTECTION_A2_PROPOSAL.md`, task bc6fa462) + A7; implementation pending (A4). |
