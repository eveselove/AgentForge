...
- IMMEDIATE LAUNCH (user directive "убираем 14 дневный тест запускаемся сразу" 2026-06-13, task-ff2e2174): 14d soak gate **REMOVED**. Full Tier3/4 excision executed immediately (stubs rm'ed in 20g+3a wave, services to pure runner/gw, docs updated). Launch pure Rust default NOW. Audit clean, marker present, 100% core. 14d references purged from active checklists/scripts. Farm rollout immediate.
